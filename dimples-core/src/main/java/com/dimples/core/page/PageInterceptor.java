...
import com.dimples.core.page.dialect.IDialect;
import com.dimples.core.page.dialect.MySqlDialect;
import com.dimples.core.page.dialect.OracleDialect;
...
public class PageInterceptor implements Interceptor {
    ...
    public static final String COUNT_SQL = "SELECT COUNT(0) FROM ( {} ) AS TOTAL";
    ...
    private void count(Invocation invocation, MetaObject metaObject, MappedStatement mappedStatement, BoundSql boundSql, Page<?> page) {
        ...
        // 改写统计总数的SQL
        String countSql = StrUtil.format(COUNT_SQL, sql);
